...
public class ProfileLogin extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button to_reg_Btn = (Button) rootView.findViewById(R.id.btnOlvidar);


        Edreg_username = (EditText) rootView.findViewById(R.id.editText);
        Edreg_password = (EditText) rootView.findViewById(R.id.txtPass);
